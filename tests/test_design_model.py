"""Regression guard for design/aprog-public.strata: the architecture
model must keep proving clean under `frob sys audit` (T-0004)."""
...
STRATA_MODEL = REPO_ROOT / "design" / "aprog-public.strata"


def test_strata_model_exists() -> None:
    """The self-model landed with T-0004 and must not silently disappear."""
