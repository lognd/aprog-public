...
sf::Uint8 expected_channel(float value) {
    return static_cast<sf::Uint8>(value + 0.5f);
}
...
TEST_CASE("blend at alpha 0.5 rounds per spec", "[blend]") {
    sf::Image base;
    base.create(1, 1, sf::Color(0, 0, 0, 255));
    sf::Image overlay;
    overlay.create(1, 1, sf::Color(9, 10, 11, 255));
